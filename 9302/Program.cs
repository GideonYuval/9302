...
namespace _9302
{
    internal class Program
    {
        ...
        public static int CountDoubleTen(Queue<int> q1, Queue<int> q2)
        {
            return 0;
        }
        ...
        public Queue<int> CharSeq (Queue<char> q)
        {
            return null;
        ...
        public Queue<int> SumPosSeq(Queue<double> q)
        {
            return null;
        ...
        public Queue<int> KLenSeq(Queue<int> q)
        {
            return null;
        }
